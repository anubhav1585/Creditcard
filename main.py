'''
in this file we are going to load the data and other pipeline
techniques
...
class CREDIT_CARD_DATA:
    ...
    def vt_hol(self):
        try:
            ...
            self.X_train_num,self.X_test_num = variable_trainsormation_outliers(self.X_train_num,self.X_test_num)
...
if __name__ == "__main__":
    try:
        obj = CREDIT_CARD_DATA('/Users/ishamittal/Desktop/creditcard/creditcard.csv')
        obj.missing_values()
        obj.vt_hol()
        obj.fs()
        obj.cat_to_num()
